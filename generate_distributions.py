...
if __name__ == '__main__':
    ...
    plt.plot(x, l_v8_cm_samples, '-.', linewidth=1, color='k')
    plt.plot(x, l_v8_ch_samples, ':', linewidth=1, color='k')
    ...
    plt.ylabel("Latencies [μs]")
    plt.xlabel("Samples number")
    plt.plot(x, a_v8_cm_samples,  '-.', linewidth=1, color='k')
    plt.plot(x, a_v8_ch_samples, ':', linewidth=1, color='k')
    plt.savefig("a_v8_distributions.pdf")

    plt.figure(2)
    plt.ylabel("Latencies [μs]")
    plt.xlabel("Samples number")
    plt.plot(x, s_v8_cm_samples,  '-.', linewidth=1, color='k')
    plt.plot(x, s_v8_ch_samples,  ':', linewidth=1, color='k')
    plt.savefig("s_v8_distributions.pdf")

    plt.figure(3)
    plt.ylabel("Latencies [μs]")
    plt.xlabel("Samples number")
    plt.plot(x, l_v7_cm_samples, '-.', linewidth=1, color='k')
    plt.plot(x, l_v7_ch_samples, ':', linewidth=1, color='k')
    ...
    plt.ylabel("Latencies [μs]")
    plt.xlabel("Samples number")
    plt.plot(x, a_v7_cm_samples,  '-.', linewidth=1, color='k')
    plt.plot(x, a_v7_ch_samples, ':', linewidth=1, color='k')
    plt.savefig("a_v7_distributions.pdf")

    plt.figure(5)
    plt.ylabel("Latencies [μs]")
    plt.xlabel("Samples number")
    plt.plot(x, s_v7_cm_samples,  '-.', linewidth=1, color='k')
    plt.plot(x, s_v7_ch_samples,  ':', linewidth=1, color='k')
