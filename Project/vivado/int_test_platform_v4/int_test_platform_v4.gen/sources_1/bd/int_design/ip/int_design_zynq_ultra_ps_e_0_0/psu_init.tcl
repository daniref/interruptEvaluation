...
set psu_clock_init_data {
    ...
    mask_write 0XFF5E00B0 0x01003F07 0x01000F02
    ...
    mask_write 0XFD1A0064 0x01003F07 0x01000500
    ...
    mask_write 0XFD1A0068 0x01003F07 0x01000500
    ...
    mask_write 0XFD1A00F8 0x00003F07 0x00000500
...
set psu_mio_init_data {
    ...
    mask_write 0XFF180204 0xFF3FDFFF 0xFE240000
...
set psu_peripherals_init_data {
    ...
    mask_write 0XFD1A0100 0x0000807E 0x00000000
		# : RESET BLOCKS
		# : TIMESTAMP
		# Register : RST_LPD_IOU2 @ 0XFF5E0238</p>
...
set psu_serdes_init_data {
    ...
    mask_write 0XFD410004 0x0000001F 0x00000011
    ...
    mask_write 0XFD406368 0x000000FF 0x00000018
    ...
    mask_write 0XFD406370 0x000000FF 0x000000D3
    ...
    mask_write 0XFD406374 0x000000FF 0x000000DA
    ...
    mask_write 0XFD4058F8 0x000000FF 0x00000096
    ...
    mask_write 0XFD4058FC 0x000000FF 0x00000096
    ...
    mask_write 0XFD405900 0x000000FF 0x00000096
    ...
    mask_write 0XFD410010 0x00000070 0x00000020
		# : CHECKING PLL LOCK
...
set psu_ps_pl_reset_config_data {
    ...
    mask_write 0XFE980004 0x80000000 0x80000000
		# : TRACE PORT SOURCE
