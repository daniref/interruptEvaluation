proc getPresetInfo {} {
  return [dict create name {pb2_preset} description {pb2_preset}  vlnv xilinx.com:ip:processing_system7:5.5 display_name {pb2_preset} ]
}
...
proc apply_preset {IPINST} {
  return [dict create \
    ...
    CONFIG.PCW_UIPARAM_DDR_BOARD_DELAY0 {0.120}  \
    CONFIG.PCW_UIPARAM_DDR_BOARD_DELAY1 {0.120}  \
    ...
    CONFIG.PCW_ACT_FPGA1_PERIPHERAL_FREQMHZ {2.000000}  \
    ...
    CONFIG.PCW_FCLK1_PERIPHERAL_DIVISOR1 {20}  \
    ...
    CONFIG.PCW_GPIO_EMIO_GPIO_WIDTH {46}  \
    ...
    CONFIG.PCW_GPIO_EMIO_GPIO_IO {46}  \
    ...
    CONFIG.PCW_MIO_TREE_PERIPHERALS {GPIO#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#USB Reset#ENET Reset#ENET Reset#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 1#Enet 1#Enet 1#Enet 1#Enet 1#Enet 1#Enet 1#Enet 1#Enet 1#Enet 1#Enet 1#Enet 1#USB 1#USB 1#USB 1#USB 1#USB 1#USB 1#USB 1#USB 1#USB 1#USB 1#USB 1#USB 1#UART 1#UART 1}  \
    CONFIG.PCW_MIO_TREE_SIGNALS {gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]/HOLD_B#qspi0_sclk#reset#reset#reset#data[0]#cmd#clk#data[1]#data[2]#data[3]#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#tx#rx}  \
