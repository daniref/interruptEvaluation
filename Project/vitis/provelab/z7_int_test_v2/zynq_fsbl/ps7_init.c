...
unsigned long ps7_clock_init_data_3_0[] = {
    ...
    // .. .. START: TRACE CLOCK
    // .. .. CLKACT_TRC = 0x1
    // .. .. ==> 0XF8000164[0:0] = 0x00000001U
    // .. ..     ==> MASK : 0x00000001U    VAL : 0x00000001U
    // .. .. CPU_1XCLKACT = 0x1
    // .. .. ==> 0XF8000164[1:1] = 0x00000001U
    // .. ..     ==> MASK : 0x00000002U    VAL : 0x00000002U
    // .. .. SRCSEL = 0x4
    // .. .. ==> 0XF8000164[6:4] = 0x00000004U
    // .. ..     ==> MASK : 0x00000070U    VAL : 0x00000040U
    // .. .. DIVISOR = 0x1
    // .. .. ==> 0XF8000164[13:8] = 0x00000001U
    // .. ..     ==> MASK : 0x00003F00U    VAL : 0x00000100U
    // .. .. 
    EMIT_MASKWRITE(0XF8000164, 0x00003F73U ,0x00000143U),
    // .. .. FINISH: TRACE CLOCK
    // .. .. CLKACT = 0x1
    ...
    // .. .. 
    EMIT_MASKWRITE(0XF8000170, 0x03F03F30U ,0x00300300U),
    // .. .. CLK_621_TRUE = 0x1
...
unsigned long ps7_ddr_init_data_3_0[] = {
    ...
    // .. .. 
    EMIT_MASKWRITE(0XF800612C, 0x000FFFFFU ,0x00000007U),
    // .. .. reg_phy_wrlvl_init_ratio = 0x7
    ...
    // .. ..     ==> MASK : 0x000FFC00U    VAL : 0x00000000U
    // .. .. 
    EMIT_MASKWRITE(0XF8006130, 0x000FFFFFU ,0x00000007U),
    ...
    // .. .. reg_phy_wr_dqs_slave_ratio = 0x7
    // .. .. ==> 0XF8006154[9:0] = 0x00000007U
    // .. ..     ==> MASK : 0x000003FFU    VAL : 0x00000007U
    ...
    // .. ..     ==> MASK : 0x000FF800U    VAL : 0x00000000U
    // .. .. 
    EMIT_MASKWRITE(0XF8006154, 0x000FFFFFU ,0x00000007U),
    // .. .. reg_phy_wr_dqs_slave_ratio = 0x7
    // .. .. ==> 0XF8006158[9:0] = 0x00000007U
    // .. ..     ==> MASK : 0x000003FFU    VAL : 0x00000007U
    // .. .. reg_phy_wr_dqs_slave_force = 0x0
    ...
    // .. ..     ==> MASK : 0x000FF800U    VAL : 0x00000000U
    // .. .. 
    EMIT_MASKWRITE(0XF8006158, 0x000FFFFFU ,0x00000007U),
    ...
    // .. .. reg_phy_fifo_we_slave_ratio = 0x55
    // .. .. ==> 0XF8006168[10:0] = 0x00000055U
    // .. ..     ==> MASK : 0x000007FFU    VAL : 0x00000055U
    ...
    // .. .. 
    EMIT_MASKWRITE(0XF8006168, 0x001FFFFFU ,0x00000055U),
    // .. .. reg_phy_fifo_we_slave_ratio = 0x55
    // .. .. ==> 0XF800616C[10:0] = 0x00000055U
    // .. ..     ==> MASK : 0x000007FFU    VAL : 0x00000055U
    // .. .. reg_phy_fifo_we_in_force = 0x0
    ...
    // .. ..     ==> MASK : 0x001FF000U    VAL : 0x00000000U
    // .. .. 
    EMIT_MASKWRITE(0XF800616C, 0x001FFFFFU ,0x00000055U),
    // .. .. reg_phy_fifo_we_slave_ratio = 0x50
    // .. .. ==> 0XF8006170[10:0] = 0x00000050U
    // .. ..     ==> MASK : 0x000007FFU    VAL : 0x00000050U
    // .. .. reg_phy_fifo_we_in_force = 0x0
    ...
    // .. ..     ==> MASK : 0x001FF000U    VAL : 0x00000000U
    // .. .. 
    EMIT_MASKWRITE(0XF8006170, 0x001FFFFFU ,0x00000050U),
    // .. .. reg_phy_fifo_we_slave_ratio = 0x50
    // .. .. ==> 0XF8006174[10:0] = 0x00000050U
    // .. ..     ==> MASK : 0x000007FFU    VAL : 0x00000050U
    // .. .. reg_phy_fifo_we_in_force = 0x0
    ...
    // .. ..     ==> MASK : 0x001FF000U    VAL : 0x00000000U
    // .. .. 
    EMIT_MASKWRITE(0XF8006174, 0x001FFFFFU ,0x00000050U),
    // .. .. reg_phy_wr_data_slave_ratio = 0x47
    // .. .. ==> 0XF800617C[9:0] = 0x00000047U
    // .. ..     ==> MASK : 0x000003FFU    VAL : 0x00000047U
    ...
    // .. ..     ==> MASK : 0x000FF800U    VAL : 0x00000000U
    // .. .. 
    EMIT_MASKWRITE(0XF800617C, 0x000FFFFFU ,0x00000047U),
    // .. .. reg_phy_wr_data_slave_ratio = 0x47
    // .. .. ==> 0XF8006180[9:0] = 0x00000047U
    // .. ..     ==> MASK : 0x000003FFU    VAL : 0x00000047U
    // .. .. reg_phy_wr_data_slave_force = 0x0
    ...
    // .. ..     ==> MASK : 0x000FF800U    VAL : 0x00000000U
    // .. .. 
    EMIT_MASKWRITE(0XF8006180, 0x000FFFFFU ,0x00000047U),
...
unsigned long ps7_post_config_3_0[] = {
    ...
    // .. .. 
    EMIT_WRITE(0XF8803FB0, 0xC5ACCE55U),
    // .. .. FINISH: TRACE LOCK ACCESS REGISTER
    // .. .. START: TRACE CURRENT PORT SIZE
    // .. .. a = 128
    // .. .. ==> 0XF8803004[31:0] = 0x00000080U
    // .. ..     ==> MASK : 0xFFFFFFFFU    VAL : 0x00000080U
    // .. .. 
    EMIT_MASKWRITE(0XF8803004, 0xFFFFFFFFU ,0x00000080U),
    ...
    // .. ..     ==> MASK : 0xFFFFFFFFU    VAL : 0x00000000U
    // .. .. 
    EMIT_WRITE(0XF8803FB0, 0x00000000U),
    // .. .. FINISH: TRACE LOCK ACCESS REGISTER
...
unsigned long ps7_ddr_init_data_2_0[] = {
    ...
    // .. .. ==> 0XF800612C[9:0] = 0x00000007U
    // .. ..     ==> MASK : 0x000003FFU    VAL : 0x00000007U
    // .. .. reg_phy_gatelvl_init_ratio = 0x80
    // .. .. ==> 0XF800612C[19:10] = 0x00000080U
    // .. ..     ==> MASK : 0x000FFC00U    VAL : 0x00020000U
    // .. .. 
    EMIT_MASKWRITE(0XF800612C, 0x000FFFFFU ,0x00020007U),
    // .. .. reg_phy_wrlvl_init_ratio = 0x7
    // .. .. ==> 0XF8006130[9:0] = 0x00000007U
    // .. ..     ==> MASK : 0x000003FFU    VAL : 0x00000007U
    // .. .. reg_phy_gatelvl_init_ratio = 0x80
    // .. .. ==> 0XF8006130[19:10] = 0x00000080U
    // .. ..     ==> MASK : 0x000FFC00U    VAL : 0x00020000U
    // .. .. 
    EMIT_MASKWRITE(0XF8006130, 0x000FFFFFU ,0x00020007U),
    // .. .. reg_phy_wrlvl_init_ratio = 0x0
    // .. .. ==> 0XF8006134[9:0] = 0x00000000U
    // .. ..     ==> MASK : 0x000003FFU    VAL : 0x00000000U
